 ...
 *
 * Diagnóstico definitivo (v4) — inspecionado ao vivo em produção:
 ...
 *  2. Injeta campo CPF com seletores exatos
...
(function () {
    ...
    function injetar(modal) {
        if (document.getElementById(INPUT_ID)) { preencherInput(_cpfCache); return; }
        ...
        /* Container do campo: div.space-y-1.5 */
    ...
    function instalarFetchIntercept() {
        ...
        window.fetch = async function (input, init) {
            ...
            if (url.includes("frappe.client.set_value")) {
                ...
                } catch (e) { console.warn("[CPF-BR] Erro intercept set_value:", e); }
            }
    ...
    function init() {
        ...
        setupObserver();
        setupClickListener();
        console.log("[CPF-BR] v4 inicializado. Modal usa v-if (childList observer ativo).");
    }
